...
{
    class FrostbiteSetExplosion : ModProjectile
    {
        int vel = 17;
        int sca = 1;
        ...
        public override void AI()
        {
            ...
            if (projectile.timeLeft <= 20) projectile.scale -= 0.05f;
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color drawColor)
        {
            for (int i = 0; i <= 3; i++)
            {
                ...
                new Vector2(52 * 0.5f, 52 * 0.5f), projectile.scale * 1.4f, SpriteEffects.None, 0f);
            }
            for (int i = 0; i <= 5; i++)
            {
                spriteBatch.Draw(mod.GetTexture("Items/Weapons/Frostbite/FrostbiteSetExplosion"), projectile.Center - Main.screenPosition,
